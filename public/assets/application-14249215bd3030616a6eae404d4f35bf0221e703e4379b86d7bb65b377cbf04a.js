...
(function() {
  ...
  runAllAnimations = function() {
    var animation_speed, drawLine1, drawLine2, drawLine3, image_offset, line_height, line_width, ruby_icon, s, showOtherBubbles;
    s = Snap('#info-1');
    ruby_icon = $(".ruby-icon");
    image_offset = 66.5;
    animation_speed = 750;
      ...
      methods: {
        ...
        signup: function() {
          if (!!this.request.name && $(this.$els.phone).inputmask('isComplete')) {
            ...
            return swal('Ошибка', 'Необходимо заполнить имя и телефон', 'error');
          }
        },
        menu: function(id) {
          this.current_tab = id;
